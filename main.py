...
# update - moving the ball by calling the move() and other stuuff

# om touch down() - When our fingers/mouse touches the screen
# on touch_up() - When we lift our finger off the screen after touching it
# on touch_move() - when we drag our fingers on the screen
